                    ...
                    <div>
                      ...
                      {doc.created_at && (
                        <p style={{ margin: '4px 0 0', color: '#94a3b8', fontSize: '0.8rem' }}>
                          Kiritildi: {doc.created_by_name || 'noma\'lum'} · {new Date(doc.created_at).toLocaleString('uz-UZ', { timeZone: 'Asia/Tashkent', day: '2-digit', month: '2-digit', year: 'numeric', hour: '2-digit', minute: '2-digit' })}
                        </p>
                      )}
                    </div>
